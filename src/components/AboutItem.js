            ...
            <div>
                ...
                <Container className="aboutMainDiv" fluid>
                    ...
                    <Row className="aboutRed">
                        ...
                        <Col className="col-md-12 col-12"><h3 className="text-center text-warning h3d">Love For Food</h3></Col>
                        
                        <Col className="col-md-5 col-10 bg-light aboutTextCon h5" style={s}>
